...
public class ResourceServerConfiguration {
    ...
    public ResourceServerConfiguration(@Value("${buzzy.oauth2.opaquetoken.introspection-uri}") String introspectionUri,
                                       @Value("${buzzy.oauth2.resources.server.client-id}") String clientId,
                                       @Value("${buzzy.oauth2.resources.server.client-secret}") String clientSecret) {
