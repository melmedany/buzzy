...
public class ApiAuthenticationConverter implements AuthenticationConverter {
    ...
    public Authentication convert(HttpServletRequest request) {
        ...
        if (StringUtils.hasText(scope)) {
            requestedScopes = new HashSet<>(List.of(StringUtils.delimitedListToStringArray(scope, " ")));
        }

        Map<String, Object> additionalParameters = parameters.entrySet().stream().filter(entry ->
        ...
        return new ApiAuthenticationToken(clientPrincipal, username, password, requestedScopes, additionalParameters);
    }
